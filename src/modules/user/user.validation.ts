...
export const resetPasswordValidate = Joi.object({
  ...
  password: Joi.string().messages({ 'string.pattern.base': 'Please enter a valid password' }),
})

export const changePasswordValidate = Joi.object({
  newPassword: Joi.string().required().messages({ 'string.pattern.base': 'Please enter a valid password' }),
  confirmNewPassword: Joi.string().required().messages({ 'string.pattern.base': 'Please enter a valid password' }),
})
