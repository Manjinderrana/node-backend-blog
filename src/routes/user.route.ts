...
import { changePassword, forgotPassword, getAllUsers, getChannelInfo,removeFromWatchHistory, resetPassword, subscribe, updateUser, watchHistory, watchLater } from '../../src/modules/user/user.controller'
import { Router } from 'express'
import { changePasswordValidate, forgotPasswordValidate, getChannelInfoValidate, removeFromWatchHistoryValidate, resetPasswordValidate, subscribeValidate, watchHistoryValidate, watchLaterValidate } from '../../src/modules/user/user.validation'
const router = Router()
